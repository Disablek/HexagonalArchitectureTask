...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<Long, PaymentProceedEvent> producerBookingFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<Long, PaymentProceedEvent> kafkaTemplate() {
        KafkaTemplate<Long, PaymentProceedEvent> template = new KafkaTemplate<>(producerBookingFactory());
